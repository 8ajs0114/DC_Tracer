...
;* Date/Time created: Tue Jan 24 02:24:53 2023                 *
;***************************************************************
...
DW$2	.dwtag  DW_TAG_subprogram, DW_AT_name("SENSOR_TIMER_ISR"), DW_AT_symbol_name("_SENSOR_TIMER_ISR")
...
;	..\Compiler\bin\opt2000.exe C:\Users\JS\AppData\Local\Temp\TI92010 C:\Users\JS\AppData\Local\Temp\TI9204 
;	..\Compiler\bin\ac2000.exe --keep_unneeded_types -D_INLINE -DLARGE_MODEL -I..\include --version=28 --keep_unneeded_types --mem_model:code=flat --mem_model:data=large -m --i_output_file C:\Users\JS\AppData\Local\Temp\TI9202 --template_info_file C:\Users\JS\AppData\Local\Temp\TI9206 --object_file DSP280x_CpuTimers.obj --embed_opts 10 --call_assumptions=0 --mem_model:code=flat --mem_model:data=large --opt_for_speed --opt_level=3 --optimizer_comments --optimizer_interlist --program_level_compile 
	.sect	".text"
...
;*** 122	-----------------------    asm(" setc INTM");
;*** 124	-----------------------    asm(" EALLOW");
;*** 127	-----------------------    PieVectTable.TINT0 = &SENSOR_TIMER_ISR;
...
;*** 141	-----------------------    return;
 ...
 EALLOW
	.dwpsn	"DSP280x_CpuTimers.c",127,3
        MOVL      XAR4,#_SENSOR_TIMER_ISR ; |127| 
